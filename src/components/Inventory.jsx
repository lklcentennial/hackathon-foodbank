                ...
                {filteredData
                    ...
                    .map((item) => {
                        ...
                        return(
                            ...
                            <td style={{backgroundColor: isExpired ? "lightsalmon" : "white"}}>{item.expiry}</td>
                            <td style={{backgroundColor: lowQuant? "lightsalmon" : highQuant? "lightgreen" : "white"}} className="text-center" >{item.quantity}</td>
                    </tr>
                )}
                )}
                </tbody>
